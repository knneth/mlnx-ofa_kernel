...
void mlx5_esw_ipsec_tx_ft_policy_set(struct mlx5e_ipsec *ipsec, struct mlx5_flow_table *ft);
#else
...
static inline void mlx5_esw_ipsec_tx_ft_policy_set(struct mlx5e_ipsec *ipsec,
