...
void mlx5e_build_aso_cq_param(struct mlx5_core_dev *mdev,
			      struct mlx5e_cq_param *param)
{
	void *cqc = param->cqc;
				 ...
				 struct mlx5e_sq_param *param)
{
	...
	MLX5_SET(wq, wq, pd,
		 param->pdn ? param->pdn : mdev->mlx5e_res.hw_objs.pdn);
...
void mlx5e_build_asosq_param(struct mlx5_core_dev *mdev,
			     struct mlx5e_sq_param *param)
{
	void *sqc = param->sqc;
	void *wq = MLX5_ADDR_OF(sqc, sqc, wq);
