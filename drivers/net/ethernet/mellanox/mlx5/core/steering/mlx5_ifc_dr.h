...
struct mlx5_ifc_ste_single_action_flow_tag_bits {
	u8         action_id[0x8];
	u8         flow_tag[0x18];
};

struct mlx5_ifc_ste_single_action_modify_list_bits {
	u8         action_id[0x8];
	u8         num_of_modify_actions[0x8];
	u8         modify_actions_ptr[0x10];
};

struct mlx5_ifc_ste_single_action_remove_header_bits {
	u8         action_id[0x8];
...
struct mlx5_ifc_ste_single_action_remove_header_size_bits {
	u8         action_id[0x8];
	u8         reserved_at_8[0x2];
	u8         start_anchor[0x6];
...
struct mlx5_ifc_ste_double_action_copy_bits {
	u8         action_id[0x8];
