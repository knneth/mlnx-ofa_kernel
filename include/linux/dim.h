...
#ifndef _COMPAT_LINUX_DIM_H
#define _COMPAT_LINUX_DIM_H

/* Include the autogenerated header file */
#include "../../compat/config.h"

#ifdef HAVE_DIM_CQ_PERIOD_MODE
#include_next <linux/dim.h>

#else /* HAVE_DIM_CQ_PERIOD_MODE */
 ...
 */
#define dim_on_top LINUX_BACKPORT(dim_on_top)
 ...
 */
#define dim_turn LINUX_BACKPORT(dim_turn)
 ...
 */
#define dim_park_on_top LINUX_BACKPORT(dim_park_on_top)
 ...
 */
#define dim_park_tired LINUX_BACKPORT(dim_park_tired)
 ...
 */
#define dim_calc_stats LINUX_BACKPORT(dim_calc_stats)
 ...
 *	@s: DIM sample
 */
#define dim_update_sample LINUX_BACKPORT(dim_update_sample)
static inline void
 ...
 *	@s: DIM sample
 */
#define dim_update_sample_with_comps LINUX_BACKPORT(dim_update_sample_with_comps)
static inline void
 ...
 *	@ix: Profile index
 */
#define net_dim_get_rx_moderation LINUX_BACKPORT(net_dim_get_rx_moderation)
 ...
 *	@cq_period_mode: CQ period mode
 */
#define net_dim_get_def_rx_moderation LINUX_BACKPORT(net_dim_get_def_rx_moderation)
 ...
 *	@ix: Profile index
 */
#define net_dim_get_tx_moderation LINUX_BACKPORT(net_dim_get_tx_moderation)
 ...
 *	@cq_period_mode: CQ period mode
 */
#define net_dim_get_def_tx_moderation LINUX_BACKPORT(net_dim_get_def_tx_moderation)
 ...
 */
#define net_dim LINUX_BACKPORT(net_dim)
 ...
 * moderation level.
 */
#define rdma_dim LINUX_BACKPORT(rdma_dim)
void rdma_dim(struct dim *dim, u64 completions);
#endif /* HAVE_DIM_CQ_PERIOD_MODE */

#endif /* _COMPAT_LINUX_DIM_H */
