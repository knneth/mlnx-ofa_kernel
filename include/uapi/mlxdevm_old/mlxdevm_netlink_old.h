...
#ifndef _COMPAT_UAPI_MLXDEVM_OLD_MLXDEVM_NETLINK_OLD_H
#define _COMPAT_UAPI_MLXDEVM_OLD_MLXDEVM_NETLINK_OLD_H
...
#endif
#endif /* _COMPAT_UAPI_MLXDEVM_OLD_MLXDEVM_NETLINK_OLD_H */
