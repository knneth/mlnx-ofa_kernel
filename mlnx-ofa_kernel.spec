...
%{!?_version: %global _version 23.07}
%{!?_release: %global _release OFED.23.07.0.2.6.1}
...
Utilities rpm.
The driver sources are located at: http://www.mellanox.com/downloads/ofed/mlnx-ofa_kernel-23.07-0.2.6.tgz
