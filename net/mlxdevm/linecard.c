...
struct mlxdevm_linecard {
	struct list_head list;
	struct mlxdevm *mlxdevm;
	unsigned int index;
	const struct mlxdevm_linecard_ops *ops;
	void *priv;
	enum mlxdevm_linecard_state state;
	struct mutex state_lock; /* Protects state */
	const char *type;
	struct mlxdevm_linecard_type *types;
